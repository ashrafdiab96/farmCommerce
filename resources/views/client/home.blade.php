...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
        @foreach ($sliders as $slider)
            @if ($slider->status == 1)
                <div class="slider-item" style="background-image: url(slider_images/{{$slider->slider_image}});">
                    <div class="overlay"></div>
                        <div class="container">
                            <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                                <div class="col-md-12 ftco-animate text-center">
                                    <h1 class="mb-2">{{$slider->slider_desc1}}</h1>
                                    <h2 class="subheading mb-4">{{$slider->slider_desc2}}</h2>
                ...
                @foreach ($products as $product)
                    @if ($product->status == 1)
                        <div class="col-md-6 col-lg-3 ftco-animate">
                            <div class="product">
                                <a href="#" class="img-prod"><img class="img-fluid" src="product_images/{{$product->product_image}}" alt="Colorlib Template">
                                    @if ($product->sale == 1)
